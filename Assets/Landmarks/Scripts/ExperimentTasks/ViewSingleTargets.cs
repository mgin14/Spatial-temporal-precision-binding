...
public class ViewSingleTargets : ExperimentTask {
    ...
    public override void startTask () {
		TASK_START();
        int curNum = transform.parent.parent.gameObject.GetComponentInParent<TaskList>().repeatCount - 1; //GameObject.Find("Spatial").GetComponent<TaskList>().repeatCount - 1;
        current = startObjects[curNum];
