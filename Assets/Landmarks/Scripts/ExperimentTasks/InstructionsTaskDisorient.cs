...
public class InstructionsTaskDisorient : ExperimentTask {
    ...
    // Melanie 12/2024 This controls the time for the subject to be distracted
    public float timeFrame = 8.0f;
    private float timer;
